...
export default function Settings() {
  ...
  return (
    <ScrollView className="h-full flex-1 gap-2 bg-[#121212] p-8 pb-20">
      <View className="flex flex-row items-center gap-2">
        <Icon name="gears" size={25} color="white" />
        <Text className="font-chalet-comprime mb-3 pt-3 text-3xl text-white">
      ...
      <View className="flex flex-row items-center gap-2">
        ...
        <Text className="font-chalet-comprime mb-3 mt-10 pt-3 text-xl text-white">
          Értesítések
        </Text>
      </View>
      ...
      <Text className="font-noto-sans-regular mb-1 text-white">
        ...
        rendelkezésedre áll. Live Chat esetében a várható válaszadási idő 1 óra,
        Email esetében 24 óra.
      </Text>
      ...
      <Text className="font-noto-sans-regular mb-8 text-white">
      ...
      <Button width="100%" height={60} onPress={() => router.push("/settings")}>
